                        ...
                        onPress: () => {
                          ...
                          if (selectedMode) {
                            ...
                            if (findCardSelected !== undefined) {
                              ...
                              console.log(branchData);
                              const sendXml = `<ashrait><request><version>2000</version><language>ENG</language><dateTime>${datetime}</dateTime><command>doDeal</command><requestId></requestId><doDeal><cardId>${
                                  ...
                                  const parsexml = xml2js
                                    ...
                                    .then(result => {
                                      ...
                                      if (
                                        ...
                                        console.log('alldata', datax, token);
                                        Helper.networkHelperTokenPost(
                                          Pref.PostOrderUrl,
                                          datax,
                                          Pref.methodPost,
                                          ...
                                          result => {
                                            ...
                                            if (
                                              ...
                                              result ===
                                              'GUID was used by this user, ack not accepted?'
                                            ) {
                                              Alert.alert(
                                                ``,
                                              ...
                                              Pref.setVal(Pref.cartItem, []);
                                              const groupedExtra = Lodash.groupBy(
                                                newArr,
                                                function(exData) {
                                              ...
                                              Object.keys(groupedExtra).map(
                                                key => {
                                                  const ooop =
                                                    groupedExtra[key];
                                                  const iii = ooop[0];
                                                  let finalPricess = Lodash.sumBy(
                                                    ooop,
                                                    function(o) {
                                                      return o.price;
                                                    },
                            ...
                            Helper.networkHelperTokenPost(
                              ...
                              result => {
                                ...
                                if (result === "order didn't went through") {
                                  ...
                                  //Pref.setVal(Pref.DummyLoaderData, allDatas);
...
סליחה ותודה.`,
  ...
  freeserviceSelect = (item, index, mode) => {
    ...
    this.setState({
      ...
      maxQuantity:
        totalselection === ogquantiy ? 0 : maxqq === 0 ? ogquantiy : maxqq,
    });
  };
  ...
  saveCardsData = () => {
    ...
    if (cardnumber === '' || cardcvv === '' || cardyear === '') {
      ...
      //const {cardId, cgUid} = doDeal;
      const sub = cardnumber.substr(12, cardnumber.length);
                ...
                <View
                  ...
                  <View
                    ...
                    <Subtitle
                      ...
                      {`${this.state.maxTitle} ${this.state.maxQuantity}`}
                    </Subtitle>
                  </View>
                </View>
                <FlatList
